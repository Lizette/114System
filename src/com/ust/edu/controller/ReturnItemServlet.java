...
public class ReturnItemServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		// getServletContext().getRequestDispatcher("/listStudent.jsp").forward(request,
		// response);;
		// response.sendRedirect("/114_System/liststudent.html#"+labID);
		String sendTo = response
				.encodeRedirectURL("/114_System/liststudent.html");
		if (request.getParameter("query") != null) {
			sendTo += "?query=" + request.getParameter("query");
		}
		sendTo += "#" + labID;
